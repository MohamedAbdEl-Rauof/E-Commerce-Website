    ...
    return (
        <div>
            ...
            <div className="w-[90%] mx-auto">
                ...
                {/* Banner Section */}
                <div
                    className="flex flex-col md:flex-row justify-between mt-12 md:mt-20 h-auto md:h-96 space-y-6 md:space-y-0">
                    {/* Left Image Section */}
                ...
                <div className="mt-14">
                    ...
                    <div
                        ...
                        {/* Address Section */}
                        <div
                            className="bg-gray-100 w-64 h-48 p-6 rounded-lg flex flex-col items-center text-center space-y-3">
